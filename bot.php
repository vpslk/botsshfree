...
// Bot criado por @LUKEVPS código original para o @LUKEVPS
...
switch ($tlg->Text ()){
	...
	$tlg->sendMessage ([
		...
		'reply_markup' => $tlg->buildInlineKeyBoard ([
			[$tlg->buildInlineKeyboardButton ('🆓 Gerar ️SSH Gratis 🆓️', null, '/sshgratis')]
		])
	]);
	...
	$tlg->sendMessage ([
		'chat_id' => $tlg->ChatID (),
		'text' => 'Bot SSH @LUKEVPS por @VPSLKGROUP'
	]);
